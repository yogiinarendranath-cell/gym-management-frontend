...
const EmailNotifications = () => {
  ...
  const handleSendEmail = async () => {
    ...
    setLoading(true);
    try {
      const email = selectedMember?.email || selectedPayment?.memberEmail;
      if (!email || email === "N/A") {
      ...
      const success = await sendEmail(email, emailSubject, emailBody);
      if (success) {
      ...
      showMessage("error", "❌ Error sending email");
    }
    setLoading(false);
  };
